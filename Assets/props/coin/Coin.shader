...
Shader "New Amplify Shader"
{
	...
	SubShader
	{
		...
		{
			float4 color2 = IsGammaSpace() ? float4(0.9716981,0.9222984,0.5271004,0) : float4(0.9368213,0.8322607,0.2399877,0);
			o.Albedo = color2.rgb;
			o.Metallic = 0.5;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
274;501;1906;676;929.5159;271.9019;1;True;True
Node;AmplifyShaderEditor.ColorNode;2;-568,-165.5;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.9716981,0.9222984,0.5271004,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;5;-343.5159,91.09814;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B5377C9C11280F745B7E2A98BF81A3E2EE0DB61C